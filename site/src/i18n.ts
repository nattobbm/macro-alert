...
const dict: Record<string, [string, string]> = {
  ...
  // 2026-09-12 三方对照：市场怎么押 / 我们怎么判 / 叙事怎么说，到期一起记账
  showdown_title: ['三方对照 · 到期结算', 'Market vs Us vs Narrative · Settled on the date'],
  showdown_hint: ['同一件事，市场用钱押、我们用逻辑链判、博主用叙事说。谁对谁错，到期公开挂着', 'Same event: the market bets money, we reason through chains, commentators narrate. Settled publicly on the date.'],
  sd_market: ['市场怎么押', 'Market'], sd_ours: ['我们怎么判', 'Us'], sd_narr: ['叙事怎么说', 'Narrative'],
  sd_no_market: ['无市场对手盘', 'no market counterpart'],
